...
{
    [Activity(Label = "MainDetail", Theme = "@style/Theme.AppCompat.Light.NoActionBar")]
    public class MainDetail : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.main_detail);

            tb = FindViewById<Android.Support.V7.Widget.Toolbar>(Resource.Id.toolbar2);
            drawer = FindViewById<DrawerLayout>(Resource.Id.drawerLayout2);
        ...
        {
            DrawerLayout drw = FindViewById<DrawerLayout>(Resource.Id.drawerLayout2);
